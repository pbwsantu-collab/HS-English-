...
const LoginPage: React.FC = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-royal-DEFAULT to-white">
      <div className="max-w-md w-full p-6 bg-white rounded shadow">
        ...
        <form className="flex flex-col gap-3">
          ...
          <div className="flex justify-end">
            <button className="px-4 py-2 bg-royal-DEFAULT text-white rounded">Login</button>
          </div>
        </form>
      </div>
    </div>
